...
class Workflow:
    ...
    def _extract_tools_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        article_query = f"{state.query} tools cpmparison best alternatives"
    ...
    def _research_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        print(f"🔬Research specific tools: {', '.join(tool_names)}")

        companies = []
        for tool_name in tool_names:
            tool_search_results = self.firecrawl.search_companies(tool_name + " official site", num_result=1)
    ...
    def _analyse_step(self, state: ResearchState) -> Dict[str, Any]:
        print("generateing recommendations")
